...
class ActivePassive(models.Model):
    ...
    passives relation presented in the Oracle database.
    """
    active_login = models.ForeignKey(Active, related_name='ActivePassive.active_login')
    passive_login = models.ForeignKey(Passive, related_name='ActivePassive.passive_register')
